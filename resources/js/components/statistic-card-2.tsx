    ...
    return (
        <div className="grid grow grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {stats.map((stat, index) => (
                ...
                >
                    <CardHeader className="relative z-10 border-0">
                            ...
                            <DropdownMenu>
                                <DropdownMenuTrigger asChild>
                                    <Button
                                        ...
                                        size="sm"
                                        mode="icon"
                                        className="-me-1.5 text-white/80 hover:text-white"
                                    >
                                        <MoreHorizontal />
                                    </Button>
                                </DropdownMenuTrigger>
                    ...
                    <CardContent className="relative z-10 space-y-2.5">
                        ...
                        <div className="mt-2 border-t border-white/20 pt-2.5 text-xs text-white/80">
                            Vs last month:{' '}
